...
const Preview = () => {
  ...
  return (
    <div id="preview_pdf" className="md:max-w-[60%] sticky top-0 preview rm-padding-print p-6 md:overflow-y-scroll md:h-screen">
      <button
                ...
                <div className="col-span-1 space-y-2">
                  {resumeData?.summary?.length > 0 && (
                    <div className="mb-1">
                      ...
                      <p className="content break-words ql-editors p-0"  dangerouslySetInnerHTML={{__html:resumeData?.summary}} />
                    </div>
                  )}
                  <div>
